...
The implementation allows the agent to:

* Understand customer intent
* Apply relevant customer context
* Consider market information
* Consider budget and currency
* Identify relevant products
* Establish pricing information
* Consider fulfilment information
* Preserve customer control
* Direct the customer to the existing Shopify product experience
